...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SendVerificationCodeButton = findViewById(R.id.btn_send_code);
        VerifyButton = findViewById(R.id.btn_verify);
        InputPhoneNumber = findViewById(R.id.edt_phoneNum);
        InputVerificationCode =  findViewById(R.id.edt_passPhone);
