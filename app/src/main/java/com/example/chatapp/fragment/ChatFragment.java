...
public class ChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chatsList = (RecyclerView) PrivateChatsView.findViewById(R.id.rv_chat_list);
    ...
    public void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Contact, ChatsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Contact, ChatsViewHolder>(options) {
                        ...
                        UsersRef.child(usersIDs).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                if (dataSnapshot.exists())
                                {
                                    ...
                                    //    holder.profileImage.setImageResource(Integer.parseInt(retImage[0]));
                    ...
                    {
                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.user_display_item_layout, viewGroup, false);
